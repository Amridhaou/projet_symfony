 ...
 */
final class Version20231207103708 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE schedule (id INT AUTO_INCREMENT NOT NULL, monday VARCHAR(190) DEFAULT NULL, tuesday VARCHAR(190) DEFAULT NULL, wednesday VARCHAR(190) DEFAULT NULL, thursday VARCHAR(190) DEFAULT NULL, friday VARCHAR(190) DEFAULT NULL, saturday VARCHAR(190) DEFAULT NULL, sunday VARCHAR(190) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
