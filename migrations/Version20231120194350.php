 ...
 */
final class Version20231120194350 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, lastname VARCHAR(190) NOT NULL, firstname VARCHAR(190) DEFAULT NULL, is_allergy TINYINT(1) DEFAULT NULL, phone VARCHAR(190) DEFAULT NULL, date DATE DEFAULT NULL, client_number INT DEFAULT NULL, time VARCHAR(190) DEFAULT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
